		...
		<div class="col-md-6 col-sm-9">
			<?php
				...
				echo '<div class="col-md-12 col-sm-12" style="padding: 0 15px; font-size: 22px; text-align: justify">';
					echo '<p>&nbsp;&nbsp;&nbsp;&nbsp;Em nossas lutas e caminhadas, ouvimos sempre algumas palavras de ordem: água, saúde, educação e energia não são mercadorias. Têm coisas que são essenciais à vida humana. <b>Saúde e educação, por exemplo, não deveriam ser fonte de lucro. Não podem virar comércio. Religião também não.</b></p>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;Os quatro evangelistas nos deixam claro que uma das poucas vezes em que Jesus perdeu a paciência e, literalmente, ‘chutou o pau da barraca’ foi quando encontrou gente fazendo comércio no Templo, explorando a fé do povo simples e ganhando dinheiro com a religião (cf. Mt 21,12-13; Mc 11,15-17; Lc 19,45; Jo 2,16). <b>A fé não pode ser fonte de lucro, mas ferramenta de partilha.</b> </p>
						...
						<p>&nbsp;&nbsp;&nbsp;&nbsp;<i>“Façam a experiência do dízimo, diz o Senhor, e vocês verão se não abro as comportas do céu, se não derramo sobre vocês as minhas bênçãos”</i> (Malaquias 3,10).</p>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;<b>Cada um(a) dê de acordo com o seu coração, <i>“conforme as suas próprias possibilidades”</i></b> (Catecismo da Igreja Católica, §2043). E que não seja de qualquer jeito, resmungando, achando ruim, mas com alegria e gratidão. Quem semeia pouco, colhe pouco. Quem semeia muito colhe muito (cf. 2Cor 9,6-7).</p>';
				echo '</div>';
			?>
		</div>
