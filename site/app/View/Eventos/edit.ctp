					...
					<div class="panel-heading"><?php echo __('Ações'); ?></div>
						<div class="panel-body">
							...
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-search"></span>&nbsp&nbsp;Detalhes Evento'), array('action' => 'view', $id, $comunidade['Comunidade']['id']), array('escape' => false)); ?> </li>
								...
								<li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;'.__('Excluir'), array('action' => 'delete', $this->Form->value('Evento.id'), $comunidade['Comunidade']['id']), array('escape' => false), __('Podem existir fotos adicionadas para este evento. Tem certeza que deseja excluir: %s?', $this->Form->value('Evento.nome'))); ?></li>
							</ul>
						</div>
					</div>
				</div>			
