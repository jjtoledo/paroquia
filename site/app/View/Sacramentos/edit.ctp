<div class="sacramentos form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Edit Sacramento'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
					...
					<div class="panel-heading"><?php echo __('Actions'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;'.__('Delete'), array('action' => 'delete', $this->Form->value('Sacramento.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Sacramento.id'))); ?></li>
																<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('List Sacramentos'), array('action' => 'index'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Sacramento', array('role' => 'form')); ?>
