<?php
	echo '<div class="col-md-12 col-sm-6 col-xs-12" style="padding: 0">';
		...
		echo '<p class="pRadio" style="text-align: justify"><span class="glyphicon glyphicon-time"></span> No ar de terça a sexta das 08h45 às 09h. Clique na imagem para escutar: </p>';
